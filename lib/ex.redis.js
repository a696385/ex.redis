 ...
 * @param {Function} [callback]
 */
exports.find = find = function(rc, collection, callback){
    if (callback == null) callback = function(){};
    var docs = [];
    async.waterfall([
        function(callback){ findIds(rc, collection, callback); },
 ...
 * @param {Function} [callback]
 */
exports.findIds = findIds = function(rc, collection, callback){
    if (callback == null) callback = function(){};
    var docs = [];
    async.waterfall([
        function(callback){ rc.keys(collection + ':data:' + '*', callback); },
        function(result, callback){
